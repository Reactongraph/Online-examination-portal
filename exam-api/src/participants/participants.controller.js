...
var ParticipantsController = /** @class */ (function () {
    function ParticipantsController(participant) {
        this.participant = participant;
    }
    // this controller is used to create participant data
    ParticipantsController.prototype.create = function (createparticipants) {
        return __awaiter(this, void 0, void 0, function () {
            var participant_create, reset_link;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(createparticipants.name);
                        return [4 /*yield*/, this.participant.create(createparticipants)];
                    case 1:
                        participant_create = _a.sent();
                        if (participant_create.email == null) {
                            return [2 /*return*/, {
                                    message: 'user already exist'
                                }];
                        }
                        return [4 /*yield*/, this.participant.reset_link(participant_create.email, participant_create.password)];
                    case 2:
                        reset_link = _a.sent();
                        return [2 /*return*/, participant_create];
                }
            });
        });
    };
    ...
    ParticipantsController.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.participant.findAll()];
                    case 1:
    ...
    ParticipantsController.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.participant.findOne(id)];
                    case 1:
                        find_one = _a.sent();
    ...
    ParticipantsController.prototype.update = function (id, updateparticipants) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.participant.update(id, updateparticipants)];
                    case 1:
    ...
    ParticipantsController.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.participant.remove(id)];
                    case 1:
    ...
    ], ParticipantsController.prototype, "create");
    __decorate([
        (0, common_1.Get)('find')
    ], ParticipantsController.prototype, "findAll");
    __decorate([
        (0, common_1.Get)(':id'),
        __param(0, (0, common_1.Param)('id'))
    ], ParticipantsController.prototype, "findOne");
    __decorate([
        (0, common_1.Patch)(':id'),
        __param(0, (0, common_1.Param)('id')),
        __param(1, (0, common_1.Body)())
    ], ParticipantsController.prototype, "update");
    __decorate([
        (0, common_1.Delete)(':id'),
        __param(0, (0, common_1.Param)('id'))
    ], ParticipantsController.prototype, "remove");
