import { Controller, FileTypeValidator, Get, MaxFileSizeValidator, ParseFilePipe, Post, UploadedFile, UploadedFiles, UseInterceptors, Body, StreamableFile, Param, Res, Patch, Delete } from '@nestjs/common'
...
export class QuestionsController {
  ...
  postAdd (@UploadedFile() profile: Express.Multer.File, @Body() createquestion: QuestionDTO): object {
    new ParseFilePipe({
      validators: [
  ...
  @Patch(':id')
  async update (@Param('id') id: string, @Body() updateparticipants: QuestionDTO) {
